...
public class RouteGenSolutionType extends SolutionType {
	...
	public RouteGenSolutionType(Problem problem) throws ClassNotFoundException {
		...
		problem.variableType_[0] = Class
				.forName("jmetal.base.variable.ArrayInt"); // areas probs
		problem.variableType_[1] = Class
				.forName("jmetal.base.variable.ArrayInt"); // area type probs
		problem.variableType_[2] = Class
				.forName("jmetal.base.variable.ArrayInt"); // area type parts
	...
	public Variable[] createVariables() {
		...
		variables[0] = new ArrayInt(3);
		variables[1] = new ArrayInt(pr.getAreaCount());
		variables[2] = new Int();
	...
	// this function splits 100 to n random length part and puts lengths to
	// array n.
